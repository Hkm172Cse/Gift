...
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title"><span style="margin-right: 3px"><i class="nav-icon fas fa-list"></i></span>Upcoming 3 Days Celebration </h3>
  ...
  <div class="card-body">
  	<div class="row">
	  	<div class="col-md-12 ">
		  	<form action="{{route('threedays.upcoming.orders.view.status')}}" method="get" class="" style="width: 310px; margin-bottom: 18px; ">
		    	@csrf
		    ...
		    <div class="input-group">
		        ...
		        <select name="status" id="status" class="custom-select form-control" style="margin-right: 10px;"> 
		        	<option ><span  class="badge bg-warning">All</span></option>
		          	<option ><span  class="badge bg-warning">Pending</span></option>
		          	<option ><span class="badge bg-success">Approved</span></option>
		      		<option ><span class="badge bg-primary">Processing</span></option>
		     		<option ><span class="badge bg-success">Delivered</span></option>
		          <option ><span class="badge bg-danger">Rejected</span></option>
		        </select>
